            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div class="p-8 md:p-10 relative z-10">
                    <div class="flex items-center mb-8 pb-6 border-b border-gray-100">
                        ...
                        <div>
                            <h3 class="text-2xl font-extrabold text-gray-900">{{ __('app.companies.details') }}</h3>
                    ...
                    <form action="{{ $formAction }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $company->name) }}" placeholder="{{ __('app.companies.name_placeholder') }}"
                                        class="{{ $errors->has('name') ? 'border-rose-300 focus:border-rose-500 focus:ring-rose-500 bg-rose-50' : 'border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 bg-gray-50 hover:bg-white' }} pl-11 block w-full rounded-xl shadow-sm sm:text-sm py-3 transition-colors" required>
                                </div>
                                @error('name')
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="url" name="website" id="website" value="{{ old('website', $company->website) }}" placeholder="{{ __('app.companies.website_placeholder') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <!-- Owner Email -->
                            <div>
                                <label for="owner_email" class="block text-sm font-bold text-gray-700 mb-2">{{ __('app.companies.owner_email') }}</label>
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 transition-colors">
                                    ...
                                    <input disabled type="email" name="owner_email" id="owner_email" value="{{ old('owner_email', $company->owner->email) }}"
                                        class="pl-11 block w-full rounded-xl shadow-sm sm:text-sm py-3 bg-gray-100 text-gray-500 cursor-not-allowed border-gray-200 focus:border-gray-200 focus:ring-0">
                                </div>
                                @error('owner_email')
                                    <p class="mt-2 text-sm text-rose-600 font-medium flex items-center"><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>{{ $message }}</p>
                                @enderror
                            ...
                            <div x-data="{ showPassword: false }">
                                <label for="owner_password" class="block text-sm font-bold text-gray-700 mb-2">{{ __('app.companies.change_owner_password') }}</label>
                                <div class="relative group">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-emerald-600 transition-colors">
