            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div class="p-8 md:p-10 relative z-10">
                    <div class="flex items-center mb-8 pb-6 border-b border-gray-100">
                        ...
                        <div>
                            <h3 class="text-2xl font-extrabold text-gray-900">{{ __('app.jobs.edit_title') }}</h3>
                            <p class="text-sm text-gray-500 mt-1 font-medium">{{ __('app.jobs.enter_details') ?? 'Update the job details below.' }}</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('job-vacancies.update', ['job_vacancy' => $jobVacancy->id, 'redirectToList' => request()->query('redirectToList')]) }}" method="POST">
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="type" id="type"
                                        ...
                                        <option value="" disabled>{{ __('app.jobs.select_type') ?? 'Select Job Type' }}</option>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="companyId" id="companyId"
                                        ...
                                        <option value="" disabled>{{ __('app.jobs.select_company') ?? 'Select Company' }}</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="jobCategoryId" id="jobCategoryId"
                                        ...
                                        <option value="" disabled>{{ __('app.jobs.select_category') ?? 'Select Job Category' }}</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <textarea rows="6" name="description" id="description"
                                        ...
                                        placeholder="{{ __('app.jobs.desc_placeholder') ?? 'Describe the job role, responsibilities, and requirements...' }}">{{ old('description', $jobVacancy->description) }}</textarea>
                                </div>
                                @error('description')
                                    <p class="mt-2 text-sm text-rose-600 font-medium flex items-center"><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>{{ $message }}</p>
                                @enderror
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100">
                            <a href="{{ request()->query('redirectToList') == 'false' ? route('job-vacancies.show', $jobVacancy->id) : route('job-vacancies.index') }}"
                            ...
                            <button type="submit"
                                ...
                                {{ __('app.jobs.update_job') ?? 'Update Job' }}
                            </button>
                        </div>
                    </form>
                </div>
