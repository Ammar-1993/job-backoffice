                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div>
                                                @php
                                                    ...
                                                    $style = $typeStyles[$jobVacancy->type] ?? 'bg-gray-50 text-gray-700 border-gray-200';
                                                @endphp
                                ...
                                <div class="grid grid-cols-2 gap-3 pt-3 border-t border-gray-50">
                                    ...
                                    <div class="flex justify-end">
                                        @php
                                            ...
                                            $styleMobile = $typeStylesMobile[$jobVacancy->type] ?? 'bg-gray-50 text-gray-700 border-gray-200';
                                        @endphp
